...
export default function Countdown({ config }: CountdownProps) {
  ...
  return (
    <div className="relative py-20 overflow-hidden silver-section"> 
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-slate-50/95 via-slate-100/90 to-slate-200/95 backdrop-blur-[2px]" />

      <div className="relative z-10 container mx-auto px-4 text-center">
        
        {/* Ikon dan Judul */}
        <Clock size={48} className="mx-auto mb-4 text-slate-600 drop-shadow-md" />
        <h2 className="text-3xl md:text-4xl font-heading text-slate-700 mb-12 tracking-wide font-medium drop-shadow-sm">
          ...
          {Object.entries(timeLeft).map(([unit, value], index) => (
            <div
              ...
              className="
                ...
                hover:shadow-2xl hover:scale-[1.02] hover:border-slate-400
                animate-fade-in-up
              "
